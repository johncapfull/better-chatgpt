...
const ChatTitle = React.memo(() => {
  ...
  return config ? (
    <>
      <div
        className='flex gap-x-4 gap-y-1 flex-wrap w-full items-center justify-center border-b border-black/10 bg-gray-50 p-2 dark:border-gray-900/50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 cursor-pointer text-xs'
        onClick={() => {
          setIsModalOpen(true);
        }}
      >
        <div className='text-center p-1 rounded-md hover:bg-gray-300/50 dark:hover:bg-gray-900/50'>
